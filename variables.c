...
*menuButtonTextSurface1 = NULL, *menuButtonTextSurface2 = NULL, *menuButtonTextSurface3 = NULL, *menuButtonTextSurface4 = NULL,
*labelSurface = NULL, *textInputSurface = NULL, *okButtonSurface = NULL, *alertTextSurface = NULL, *infoTextSurface = NULL,
*tileTextSurface = NULL, *mineIconSurface = NULL, *mineBoomIconSurface = NULL, *mineDeathIconSurface = NULL, *flagIconSurface = NULL,
*edgeIconSurface = NULL, *coverIconSurface = NULL, *finaleTextSurface = NULL;
...
*labelTexture = NULL, *textInputTexture = NULL, *okButtonTexture = NULL, *alertTextTexture = NULL, *infoTextTexture = NULL,
*tileTextTexture = NULL, *mineIconTexture = NULL, *mineBoomIconTexture = NULL, *mineDeathIconTexture = NULL, *flagIconTexture = NULL,
*edgeIconTexture = NULL, *coverIconTexture = NULL, *finaleTextTexture = NULL;
