...
int mineRemainingInt = 0;

float delta_time = 0.0f;
char *aux = NULL;
char paramInput1[3] = {0}, paramInput2[3] = {0}, paramInput3[4] = {0}, mineRemainingStr[4] = {0}, mineRemainingConcat[18] = MINE_INGAME_INFO;
